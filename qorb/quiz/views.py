...
from qorb.teacher.models import Teacher , Course
from qorb.accounts.models import Student , Profile
from .models import Quiz, QuestionAnswer, QuizStudent
from .forms import CreateQuizForm, CreateQuestionAnswerForm
...
def quizzes(request):
    ...
    if request.method == 'POST':
        ...
        form = CreateQuizForm()
    return render(request, 'quiz/quiz_list.html', {'quizzes': quizzes,'user_profile':user_profile,'form': form , 'msg':msg})
