...
from qorb.accounts.decorators import allow_user
from qorb.accounts.models import Profile, Student, Teacher
...
def report_grades_update(request, id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            new_form.save()
            return redirect(
                "report-grades-view", course=course_name, report=report_name
            )
    ...
    return render(
        ...
        {"form": form, "report_grades": report_grades},
    )
